package com.doorstep24.doorstep.Scripts.auth

import android.app.Activity
import android.util.Log
import com.doorstep24.doorstep.Interface.ChangeFragment
import com.doorstep24.doorstep.Interface.OtpUiChange
//import com.doorstep24.doorstep.Scripts.auth.FirebaseFunctions.FireBaseCRUD
                ...
                if (task.isSuccessful) {
                    ...
                    docIdRef.get().addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            Firebase.firestore.collection("Customers").document(user?.uid!!).set(userCreate!!,
