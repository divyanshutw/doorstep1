...
import com.doorstep24.doorstep.viewModels.PaymentFinalViewModel
import com.doorstep24.doorstep.viewModels.PaymentFinalViewModelFactory
                ...
                if(response["value"] as Boolean){
                    //startActivity(Intent(applicationContext,DeliveryMapsActivityFinal::class.java))
                        if(this.paymentData != null){
                            ...
                            Toast.makeText(this@PaymentActivityFinal, "💯 Order placed 💯", Toast.LENGTH_LONG)
                            finish()
                        }
                }else{
