...
import com.doorstep24.doorstep.activities.CartActivity
import com.doorstep24.doorstep.activities.MapsActivityFinal

import com.doorstep24.doorstep.adapters.HomeFragmentCategoryRecyclerAdapter
import com.doorstep24.doorstep.adapters.HomeFragmentProductRecyclerAdapter
import com.doorstep24.doorstep.databinding.FragmentHomeBinding
...
//            view?.findNavController()?.navigate(R.id.action_navigation_home_to_cartFragment)
    ...
    private fun initObservers() {
        ...
        viewModel.favoritesList.observe(viewLifecycleOwner){
            if(viewModel.favoritesList.value!=null && viewModel.productsList.value!=null){
